...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteMessage (int id, int userId)
        {
            ...
            var messagFromRepo = await _repo.GetMessage(id);

            if (messagFromRepo.SenderId == userId)
                messagFromRepo.SenderDeleted = true;
            else
                messagFromRepo.RecipientDeleted = true;

            if (messagFromRepo.SenderDeleted && messagFromRepo.RecipientDeleted)
